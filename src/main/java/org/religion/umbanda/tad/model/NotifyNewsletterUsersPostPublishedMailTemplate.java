...
public class NotifyNewsletterUsersPostPublishedMailTemplate implements GeneralMailTemplate<NewsletterContent> {

    private final String subject;
    private final String body;

    NotifyNewsletterUsersPostPublishedMailTemplate(String subject, String body) {
